...
const activeLinkClasses = "flex items-center gap-3 px-4 py-3 rounded-sm transition-all duration-150 active:scale-90 text-[#DF2225] bg-[#DF2225]/10 border-r-2 border-[#DF2225] font-bold";
const inactiveLinkClasses = "flex items-center gap-3 px-4 py-3 rounded-sm text-gray-400 hover:text-white transition-colors hover:bg-[#2D2D32] group";
