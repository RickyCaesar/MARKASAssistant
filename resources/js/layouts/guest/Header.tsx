...
const activeLinkClasses =
    "tracking-tight text-sm uppercase font-bold text-[#DF2225] border-b-2 border-[#DF2225] pb-1";
const inactiveLinkClasses =
    "tracking-tight text-sm uppercase font-bold text-gray-400 hover:text-white transition-all duration-200";
...
const LinkComponentMobileLoginVersion = ({
    href,
    version,
}: {
    href: string;
    ...
    return (
        <Link
            href={href}
            className="tracking-tight text-sm uppercase font-bold text-gray-300 hover:text-white transition-all duration-200"
        >
            <span className="text-[#DF2225] mr-2">{version}</span> Login{" "}
            {version}
        </Link>
    );
};

const LinkComponentMobileRegisterVersion = ({
    href,
    version,
}: {
    href: string;
    ...
    return (
        <Link
            ...
            className="tracking-tight text-sm uppercase font-bold text-gray-300 hover:text-white transition-all duration-200"
        >
            <span className="text-[#DF2225] mr-2">{version}</span> Daftar{" "}
            {version}
        </Link>
    );
};
                ...
                {mobileMenuOpen && (
                    <div className="lg:hidden bg-[#0D0D0F] border-b border-[#2D2D32] px-8 py-4 flex flex-col space-y-4">
                        ...
                        <div className="pt-4 border-t border-[#2D2D32] flex flex-col space-y-3">
                            ...
                            <LinkComponentMobileLoginVersion
                                href="/loginv1"
                                version="V.1"
                            />
                            <LinkComponentMobileLoginVersion
                        ...
                        <div className="pt-4 border-t border-[#2D2D32] flex flex-col space-y-3">
                            ...
                            <LinkComponentMobileRegisterVersion
                                href="/register"
                                version="V.1"
                            />
                            <LinkComponentMobileRegisterVersion
